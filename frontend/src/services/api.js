...
export const authAPI = {
  ...
  verifyEmail: (email, code) =>
    backendAPI.post("/auth/verifyEmail", { email, code }),
...
export const profileAPI = {
  ...
  updatePreferences: (preferences) =>
    backendAPI.put("/profile/preferences", preferences),
};
...
export const foodCategoriesAPI = {
  ...
  update: (id, categoryData) =>
    backendAPI.put(`/foodCategories/${id}`, categoryData),
...
export const recipeAPI = {
  ...
  getRecipeInstructions: (id) =>
    spoonacularAPI.get(`/${id}/analyzedInstructions`),
...
export const mealPlanAPI = {
  ...
  updateMealPlan: (id, mealPlanData) =>
    backendAPI.put(`/mealPlans/${id}`, mealPlanData),
...
export const groceryListAPI = {
  ...
  createGroceryList: (mealPlanId) =>
    backendAPI.post(`/grocery-lists/from-meal-plan/${mealPlanId}`),
  ...
  updateGroceryList: (id, listData) =>
    backendAPI.put(`/grocery-lists/${id}`, listData),
...
export const nutritionAPI = {
  ...
  getNutritionSummary: (period) =>
    backendAPI.get(`/nutrition/summary/${period}`),
};
